<?php
include "db.php";
$conn->query("ALTER TABLE students ADD COLUMN IF NOT EXISTS requested_room_id INT DEFAULT NULL");
$conn->query("ALTER TABLE students ADD COLUMN IF NOT EXISTS requested_at DATETIME DEFAULT NULL");
